...
DO $$
BEGIN
    RAISE NOTICE 'Company ratings table updated successfully';
    RAISE NOTICE 'New columns added: rating_score, fit_level, breakdown, strengths, concerns, recommendation';
END $$;
